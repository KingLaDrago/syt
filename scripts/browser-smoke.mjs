...
// Allow the script to write into the checked-in project folder when running
// outside the Grok sandbox (where `/workspace` may not exist). This lets
// local developers run the smoke checks and capture screenshots under the
// repository `screenshots/` directory.
